...
{
    [Serializable]
    [DataContract(Name = "gen_certificatesubjectsEntity", Namespace = "http://www.KAF.com/types")]
    public partial class gen_certificatesubjectsEntity : BaseEntity
    {
        #region Properties
    
        protected long ? _certificatesubjectid;
        protected long ? _certificateid;
        protected string _certificatesubjectname;
        ...
        [DataMember]
        [MaxLength(300)]
        [Display(Name = "certificatesubjectname", ResourceType = typeof(CLL.LLClasses.Models._gen_certificatesubjects))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._gen_certificatesubjects), ErrorMessageResourceName = "certificatesubjectnameRequired")]
        public string certificatesubjectname
        {
            get { return _certificatesubjectname; }
            set { _certificatesubjectname = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [Display(Name = "years", ResourceType = typeof(CLL.LLClasses.Models._gen_certificatesubjects))]
        public int ? years
        {
            get { return _years; }
            set { _years = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [MaxLength(150)]
        [Display(Name = "comment", ResourceType = typeof(CLL.LLClasses.Models._gen_certificatesubjects))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(CLL.LLClasses.Models._gen_certificatesubjects))]
        ...
        public gen_certificatesubjectsEntity():base()
        {
        }
        
        public gen_certificatesubjectsEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public gen_certificatesubjectsEntity(IDataReader reader, bool IsListViewShow)
        {
            this.LoadFromReader(reader, IsListViewShow);
        }

        public gen_certificatesubjectsEntity(IDataReader reader, int e)
        {
