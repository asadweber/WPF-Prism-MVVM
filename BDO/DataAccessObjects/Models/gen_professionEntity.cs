...
{
    [Serializable]
    [DataContract(Name = "gen_professionEntity", Namespace = "http://www.KAF.com/types")]
    public partial class gen_professionEntity : BaseEntity
    {
        ...
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._gen_profession), ErrorMessageResourceName = "professionnameRequired")]
        ...
        [DataMember]
        [MaxLength(1000)]
        [Display(Name = "comment", ResourceType = typeof(CLL.LLClasses.Models._gen_profession))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(CLL.LLClasses.Models._gen_profession))]
        ...
        public gen_professionEntity():base()
        {
        }
        
        public gen_professionEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public gen_professionEntity(IDataReader reader, bool IsListViewShow)
        {
            this.LoadFromReader(reader, IsListViewShow);
        }

        public gen_professionEntity(IDataReader reader, int e)
        {
            this.LoadFromReader(reader, e);
        }

        public gen_professionEntity(IDataReader reader, string ext)
        {
