...
{
    [Serializable]
    [DataContract(Name = "gen_candidatetypeEntity", Namespace = "http://www.KAF.com/types")]
    public partial class gen_candidatetypeEntity : BaseEntity
    {
        ...
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._gen_candidatetype), ErrorMessageResourceName = "candidatetypenameRequired")]
        ...
        [DataMember]
        [MaxLength(1000)]
        [Display(Name = "comment", ResourceType = typeof(CLL.LLClasses.Models._gen_candidatetype))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(CLL.LLClasses.Models._gen_candidatetype))]
        ...
        public gen_candidatetypeEntity():base()
        {
        }
        
        public gen_candidatetypeEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public gen_candidatetypeEntity(IDataReader reader, bool IsListViewShow)
        {
            this.LoadFromReader(reader, IsListViewShow);
        }

        public gen_candidatetypeEntity(IDataReader reader, int e)
        {
