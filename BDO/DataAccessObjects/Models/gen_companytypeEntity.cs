...
{
    [Serializable]
    [DataContract(Name = "gen_companytypeEntity", Namespace = "http://www.KAF.com/types")]
    public partial class gen_companytypeEntity : BaseEntity
    {
        #region Properties
        ...
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._gen_companytype), ErrorMessageResourceName = "companytypenameRequired")]
        ...
        [DataMember]
        [MaxLength(150)]
        [Display(Name = "comment", ResourceType = typeof(CLL.LLClasses.Models._gen_companytype))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(CLL.LLClasses.Models._gen_companytype))]
        ...
        public gen_companytypeEntity() : base()
        {
        }

        public gen_companytypeEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }

        public gen_companytypeEntity(IDataReader reader, bool IsListViewShow)
        {
