...
{
    public partial class cnf_fileconfignameEntity
    {
        [DataMember]
        ...
        protected void LoadFromReader(IDataReader reader, int e)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("IsRequired"))) isrequired = reader.GetBoolean(reader.GetOrdinal("IsRequired"));
