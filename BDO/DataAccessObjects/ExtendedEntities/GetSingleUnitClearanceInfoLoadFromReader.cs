...
{
    public partial class GetSingleUnitClearanceInfoLoadFromReader : reg_registrationinfoEntity
    {
        public GetSingleUnitClearanceInfoLoadFromReader(IDataReader reader)
        {
