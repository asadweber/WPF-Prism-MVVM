...
{
    public partial class GetSingleTrainingJoinInfoLoadFromReader : reg_registrationinfoEntity
    {
        public GetSingleTrainingJoinInfoLoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("GroupNo"))) GroupNo = reader.GetString(reader.GetOrdinal("GroupNo"));
                if (!reader.IsDBNull(reader.GetOrdinal("JoiningBatchID"))) JoiningBatchID = reader.GetInt64(reader.GetOrdinal("JoiningBatchID"));
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("TrgJoinRemarks"))) TrgJoinRemarks = reader.GetString(reader.GetOrdinal("TrgJoinRemarks"));
