...
namespace BDO.Report
{
    ...
    {
        public RptFamilyInfo()
        {

        }
        public RptFamilyInfo( IDataReader reader)
        {
        ...
        protected void loadFormLoader(IDataReader reader)
        {
            if (reader!=null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("CompanyAddress"))) CompanyAddress = reader.GetString(reader.GetOrdinal("CompanyAddress"));
                if (!reader.IsDBNull(reader.GetOrdinal("IsMarried"))) IsMarried = reader.GetBoolean(reader.GetOrdinal("IsMarried"));
                if (!reader.IsDBNull(reader.GetOrdinal("FamilyMarriageDate"))) FamilyMarriageDate = reader.GetDateTime(reader.GetOrdinal("FamilyMarriageDate"));
                if (!reader.IsDBNull(reader.GetOrdinal("FamilyMarriageDocDate"))) FamilyMarriageDocDate = reader.GetDateTime(reader.GetOrdinal("FamilyMarriageDocDate"));
                if (!reader.IsDBNull(reader.GetOrdinal("FamilyMarriageDocNo"))) FamilyMarriageDocNo = reader.GetString(reader.GetOrdinal("FamilyMarriageDocNo"));
