...
{
    public sealed partial class Gen_FaqUseCase : IGen_FaqUseCase
    {
        ...
        public async Task<bool> GetAll(Gen_FaqRequest message, ICRUDRequestHandler<Gen_FaqResponse> outputPort)
        {
            ...
            try
            {
                ...
                .GetAll(message.Objgen_faq, cancellationToken);
                ...
                {
                    Gen_FaqResponse objResponse = new Gen_FaqResponse(true, _sharedLocalizer["NO_DATA_FOUND"], new Error(
                     "404",
                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
									 ...
									 t.answersen,
									 t.tags,
									 t.urls,                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objgen_faq.ControllerName, t.faqid, "faqid", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList)
                                }).ToList();

                    outputPort.GetListView(new Gen_FaqResponse(new AjaxResponse(oblist[0].RETURN_KEY, data), true, null));
                    return true;
                }
                else
                {
        ...
        public async Task<bool> Save(Gen_FaqRequest message, ICRUDRequestHandler<Gen_FaqResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Save(new Gen_FaqResponse(new AjaxResponse("200", _sharedLocalizer["DATA_SAVE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Update(Gen_FaqRequest message, ICRUDRequestHandler<Gen_FaqResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Update(new Gen_FaqResponse(new AjaxResponse("200", _sharedLocalizer["DATA_UPDATE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                        ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Delete(Gen_FaqRequest message, ICRUDRequestHandler<Gen_FaqResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Delete(new Gen_FaqResponse(new AjaxResponse("200", _sharedLocalizer["DATA_DELETE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                       ), true, null));
                return true;
            }
            catch (Exception ex)
