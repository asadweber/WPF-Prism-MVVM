...
{
    public sealed partial class Gen_ServicesUseCase : IGen_ServicesUseCase
    {
        ...
        public async Task<bool> GetAll(Gen_ServicesRequest message, ICRUDRequestHandler<Gen_ServicesResponse> outputPort)
        {
            ...
            try
            {
                ...
                .GetAll(message.Objgen_services, cancellationToken);
                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
									 ...
									 t.servicelogopath,
									 t.serviceurl,                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objgen_services.ControllerName, t.serviceid, "serviceid", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList)
                                }).ToList();

                    outputPort.GetListView(new Gen_ServicesResponse(new AjaxResponse(oblist[0].RETURN_KEY, data), true, null));
                    return true;
                }
                else
                {
        ...
        public async Task<bool> Save(Gen_ServicesRequest message, ICRUDRequestHandler<Gen_ServicesResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Save(new Gen_ServicesResponse(new AjaxResponse("200", _sharedLocalizer["DATA_SAVE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Update(Gen_ServicesRequest message, ICRUDRequestHandler<Gen_ServicesResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Update(new Gen_ServicesResponse(new AjaxResponse("200", _sharedLocalizer["DATA_UPDATE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                        ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Delete(Gen_ServicesRequest message, ICRUDRequestHandler<Gen_ServicesResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Delete(new Gen_ServicesResponse(new AjaxResponse("200", _sharedLocalizer["DATA_DELETE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                       ), true, null));
                return true;
            }
            catch (Exception ex)
