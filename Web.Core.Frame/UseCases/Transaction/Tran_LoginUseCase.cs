                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
                                    ...
                                    t.tokenissuedate,
                                    t.expires,
                                    t.remarks,                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objtran_login.ControllerName, t.serialloginid, "serialloginid", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList)
                                }).ToList();
