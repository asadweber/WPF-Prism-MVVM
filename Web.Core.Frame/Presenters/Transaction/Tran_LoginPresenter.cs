...
namespace Web.Core.Frame.Presenters.Transaction
{
    ...
    /// Tran_LoginPresenter
    /// </summary>
    public sealed partial class Tran_LoginPresenter : IOutputPort<Tran_LoginResponse>, ICRUDRequestHandler<Tran_LoginResponse>
    {
        /// <summary>
        /// ContentResult
        /// </summary>
        ...
        public void GetAll(Tran_LoginResponse response)
        {
            ...
            Result = response.Success ? response._tran_LoginList as object : response.Errors;
        }
        /// <summary>
        /// GetAllPaged
        /// </summary>
        ...
        public void GetSingle(Tran_LoginResponse response)
        {
            ...
            Result = response.Success ? response._tran_Login as object : response.Errors;
        }
        ...
        {
            ContentResult.StatusCode = (int)(response.Success ? HttpStatusCode.OK : httpStatusCodeParser.SetHttpStatusCode(response.Errors));
            ContentResult.Content = response.Success ? JsonSerializer.SerializeObject(new Tran_LoginResponse(response._ajaxresponse, response.Success)) : JsonSerializer.SerializeObject(response.Errors);
