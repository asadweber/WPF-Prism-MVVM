...
namespace  Web.Core.Frame.Presenters
{
    ...
    /// </summary>
    public sealed partial class Gen_ServicesPresenter : IOutputPort<Gen_ServicesResponse>, ICRUDRequestHandler<Gen_ServicesResponse>
    {
         /// <summary>
        /// ContentResult
        /// </summary>
        ...
        public void GetAll(Gen_ServicesResponse response)
        {
            ...
            Result = response.Success ? response._gen_ServicesList as object : response.Errors;
        }
        /// <summary>
        /// GetAllPaged
        /// </summary>
        ...
        public void GetSingle(Gen_ServicesResponse response)
        {
            ...
            Result = response.Success ? response._gen_Services as object : response.Errors;
        }
        ...
        {
            ContentResult.StatusCode = (int)(response.Success ? HttpStatusCode.OK : httpStatusCodeParser.SetHttpStatusCode(response.Errors));
            ContentResult.Content = response.Success ? JsonSerializer.SerializeObject(new Gen_ServicesResponse(response._ajaxresponse, response.Success)) : JsonSerializer.SerializeObject(response.Errors);
