...
namespace  Web.Core.Frame.Presenters
{
    ...
    /// </summary>
    public sealed partial class Gen_ImageGallaryPresenter : IOutputPort<Gen_ImageGallaryResponse>, ICRUDRequestHandler<Gen_ImageGallaryResponse>
    {
         /// <summary>
        /// ContentResult
        /// </summary>
        ...
        public void GetAll(Gen_ImageGallaryResponse response)
        {
            ...
            Result = response.Success ? response._gen_ImageGallaryList as object : response.Errors;
        }
        /// <summary>
        /// GetAllPaged
        /// </summary>
        ...
        public void GetSingle(Gen_ImageGallaryResponse response)
        {
            ...
            Result = response.Success ? response._gen_ImageGallary as object : response.Errors;
        }
        ...
        {
            ContentResult.StatusCode = (int)(response.Success ? HttpStatusCode.OK : httpStatusCodeParser.SetHttpStatusCode(response.Errors));
            ContentResult.Content = response.Success ? JsonSerializer.SerializeObject(new Gen_ImageGallaryResponse(response._ajaxresponse, response.Success)) : JsonSerializer.SerializeObject(response.Errors);
