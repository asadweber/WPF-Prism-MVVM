...
namespace  Web.Core.Frame.Presenters
{
    ...
    /// Gen_FaqPresenter
    /// </summary>
    public sealed partial class Gen_FaqPresenter : IOutputPort<Gen_FaqResponse>, ICRUDRequestHandler<Gen_FaqResponse>
    {
         /// <summary>
        /// ContentResult
        /// </summary>
        ...
        public void GetAll(Gen_FaqResponse response)
        {
            ...
            Result = response.Success ? response._gen_FaqList as object : response.Errors;
        }
        /// <summary>
        /// GetAllPaged
        /// </summary>
        ...
        public void GetSingle(Gen_FaqResponse response)
        {
            ...
            Result = response.Success ? response._gen_Faq as object : response.Errors;
        }
        ...
        {
            ContentResult.StatusCode = (int)(response.Success ? HttpStatusCode.OK : httpStatusCodeParser.SetHttpStatusCode(response.Errors));
            ContentResult.Content = response.Success ? JsonSerializer.SerializeObject(new Gen_FaqResponse(response._ajaxresponse, response.Success)) : JsonSerializer.SerializeObject(response.Errors);
