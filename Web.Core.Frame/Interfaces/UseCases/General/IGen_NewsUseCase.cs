...
namespace Web.Core.Frame.Interfaces.UseCases
{
    public partial interface IGen_NewsUseCase : IUseCaseRequestHandler<Gen_NewsRequest, Gen_NewsResponse>
    {
        ...
        Task<bool> SaveMasterDetgen_newsgallery(Gen_NewsRequest message, ICRUDRequestHandler<Gen_NewsResponse> outputPort);
        Task<bool> UpdateMasterDetgen_newsgallery(Gen_NewsRequest message, ICRUDRequestHandler<Gen_NewsResponse> outputPort);
