...
{
    [ServiceContract(Name = "Itran_rollbackinfoFacadeObjects")]
    public partial interface Itran_rollbackinfoFacadeObjects : IDisposable
    { 
        ...
        [OperationContract]
        Task<long> SaveList(List<tran_rollbackinfoEntity> list , CancellationToken cancellationToken);
